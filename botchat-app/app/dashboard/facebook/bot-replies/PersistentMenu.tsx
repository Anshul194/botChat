                ...
                <div className="flex-1 space-y-3">
                    ...
                    <div className="flex flex-col gap-1">
                        ...
                        <input
                            ...
                            className="w-full px-4 py-2 rounded-xl bg-neutral-50 dark:bg-neutral-950 border border-neutral-100 dark:border-neutral-800 text-sm outline-none focus:border-[#0866FF]/30 dark:focus:border-[#0866FF]/30 transition-all font-semibold"
                        />
                    </div>
                    ...
                    <div className="flex flex-col gap-1">
                        ...
                        <select
                            ...
                            className="w-full px-4 py-2 rounded-xl bg-neutral-50 dark:bg-neutral-950 border border-neutral-100 dark:border-neutral-800 text-sm outline-none focus:border-[#0866FF]/30 dark:focus:border-[#0866FF]/30 transition-all font-semibold appearance-none"
                        >
                        ...
                        <div className="flex flex-col gap-1 animate-in slide-in-from-top-2 duration-300">
                            ...
                            <div className="relative">
                                ...
                                <select
                                    ...
                                    className="w-full pl-10 pr-4 py-2 rounded-xl bg-neutral-50 dark:bg-neutral-950 border border-neutral-100 dark:border-neutral-800 text-sm outline-none focus:border-[#0866FF]/30 dark:focus:border-[#0866FF]/30 transition-all font-semibold appearance-none"
                                >
                ...
                <div className="mt-4 pt-4 border-t border-pink-50 dark:border-pink-900/20">
                    <div className="flex items-center justify-between mb-2">
                        <div className="flex items-center gap-2">
                            ...
                            <span className="text-[11px] font-semibold uppercase text-neutral-500 tracking-wider">Sub Menu Items ({item.call_to_actions?.length || 0}/5)</span>
                        </div>
                        <button
                            onClick={() => onAddSub(index)}
                            className="px-3 py-1.5 rounded-lg bg-[#0866FF]/5 dark:bg-[#0866FF]/10 text-[#0866FF] text-[10px] font-semibold uppercase tracking-widest hover:bg-[#0866FF]/10 transition-all flex items-center gap-1.5"
                        >
    ...
    return (
        <div className="w-full space-y-6 pb-12 animate-in fade-in duration-500">
            ...
            <div className="flex flex-wrap gap-4">
                ...
                {/* Add item tile */}
                <div className="flex-1 min-w-[300px] flex items-center justify-between px-5 bg-neutral-50/30 dark:bg-neutral-900/30 border border-dashed border-neutral-100 dark:border-neutral-800 rounded-2xl p-5">
                    <div className="space-y-1">
                        <div className="flex items-center gap-2">
                            <Layers className="w-4 h-4 text-[#0866FF]" />
                            <h3 className="text-[10px] font-semibold text-neutral-400 uppercase tracking-widest leading-none">Menu Items ({items.length}/3)</h3>
                        </div>
                    ...
                    <button
                        ...
                        className="px-6 py-2.5 rounded-2xl bg-[#0866FF] hover:bg-[#0055D4] text-white text-[10px] font-semibold uppercase tracking-widest hover:scale-[1.02] active:scale-95 transition-all flex items-center gap-2 shadow-xl shadow-[#0866FF]/20 disabled:opacity-50"
                    >
