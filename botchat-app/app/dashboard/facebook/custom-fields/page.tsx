      ...
      <div className="bg-white dark:bg-slate-900 border-b border-slate-100 dark:border-slate-800 sticky top-0 z-40 transition-all">
        <div className="max-w-[1400px] mx-auto px-8 py-6 flex items-center justify-between">
          ...
          <button
            ...
            className="px-8 py-4 bg-[var(--primary)] text-[var(--primary-foreground)] font-black text-[11px] uppercase tracking-[0.2em] rounded-xl shadow-2xl shadow-[var(--primary)]/15 hover:scale-[1.03] active:scale-95 transition-all flex items-center gap-3 "
          >
            ...
            >
              ...
              <div className="flex flex-col sm:flex-row gap-4 mt-12">
                ...
                <button
                  ...
                  className="flex-[1.5] py-5 rounded-2xl bg-rose-600 hover:bg-rose-700 text-white font-black text-[11px] uppercase tracking-[0.2em] shadow-xl shadow-rose-600/20 active:scale-95 transition-all"
                >
                  Yes, Delete Property
                </button>
              </div>
