...
import { Facebook, Check, X, RefreshCw, Webhook, Plus, ExternalLink, Shield, Users, MessageSquare, TrendingUp } from "lucide-react";

const permissions = [
    { name: "pages_messaging", granted: true },
    { name: "pages_read_engagement", granted: true },
    { name: "pages_manage_metadata", granted: true },
    { name: "pages_show_list", granted: true },
    { name: "business_management", granted: false },
];

const stats = [
    { label: "Page Likes", value: "18.3K", icon: Users, color: "#3b82f6" },
    { label: "DMs Handled", value: "24.1K", icon: MessageSquare, color: "#7c3aed" },
    { label: "Response Rate", value: "91%", icon: TrendingUp, color: "#10b981" },
];
    ...
    return (
        <div className="space-y-6 max-w-[900px] p-4 sm:p-6">
            ...
            <div className="glass-card rounded-2xl p-6 relative overflow-hidden">
                <div className="absolute inset-0 opacity-10 pointer-events-none" style={{ background: "linear-gradient(135deg,#3b82f6,#06b6d4)" }} />
                <div className="relative flex flex-col md:flex-row md:items-center justify-between gap-4">
                    <div className="flex items-center gap-4">
                        <div className="w-16 h-16 rounded-2xl flex items-center justify-center"
                            style={{ background: "linear-gradient(135deg,#1d4ed8,#3b82f6)", boxShadow: "0 8px 30px rgba(59,130,246,0.4)" }}>
                            <Facebook className="w-8 h-8 text-white" />
                        </div>
                        <div>
                            <div className="flex items-center gap-2 mb-1">
                                <h2 className="text-lg font-bold" style={{ color: "var(--foreground)" }}>My Brand Page</h2>
                            ...
                            <p className="text-sm" style={{ color: "var(--muted-foreground)" }}>Facebook Page · Connected Jan 28, 2025</p>
                        </div>
                    </div>
                        ...
                        <div key={p.name} className="flex items-center justify-between p-3 rounded-xl"
                            ...
                            <div className="flex items-center gap-3">
                                <div className="w-8 h-8 rounded-lg flex items-center justify-center"
                                    ...
                                    {p.granted ? <Check className="w-4 h-4" style={{ color: "#10b981" }} /> : <X className="w-4 h-4" style={{ color: "#ef4444" }} />}
                                </div>
            ...
            <div className="glass-card rounded-2xl p-6">
                <div className="flex items-center justify-between mb-5">
                    <div className="flex items-center gap-2">
                        ...
                        <h2 className="text-base font-semibold" style={{ color: "var(--foreground)" }}>Messenger Webhook</h2>
                    </div>
                ...
                <div className="space-y-4">
                    {[
                        { label: "Callback URL", value: "https://botchat.io/webhook/fb/abc123" },
                        { label: "Verify Token", value: "bch_fb_verify_secret_xyz" },
                    ].map((f) => (
                        <div key={f.label}>
                    ...
                    <div className="flex flex-wrap gap-2 pt-1">
                        {["messages", "messaging_postbacks", "messaging_referrals", "feed"].map((sub) => (
            ...
            <div className="glass-card rounded-2xl p-6 text-center" style={{ borderStyle: "dashed", borderColor: "var(--glass-border)" }}>
                ...
                <p className="text-sm font-semibold mb-1" style={{ color: "var(--foreground)" }}>Connect Another Page</p>
                <p className="text-xs mb-4" style={{ color: "var(--muted-foreground)" }}>Your Pro plan supports up to 3 Facebook Pages</p>
