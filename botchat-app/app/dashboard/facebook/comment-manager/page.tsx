...
export default function CommentManager() {
 ...
 <span className="text-[9px] font-medium tracking-widest leading-none text-[#0866FF]">Facebook</span>
 ...
 <span className="text-[10px] font-bold text-[var(--muted-foreground)] tracking-wider">Neural Live</span>
 </div>
 </div>
 </div>
 </div>
 ...
 <h2 className="text-sm sm:text-md font-bold text-[var(--foreground)] tracking-tight">Strategy Lab</h2>
 ...
 <p className="text-[10px] font-semibold text-[var(--muted-foreground)] mt-1">Auto Replies</p>
 </div>
 <div className="p-4 rounded-xl bg-[var(--muted)]/40 border border-[var(--border)] text-center">
 <p className="text-3xl font-bold text-[var(--primary)]">{pageStats.auto_comment_count}</p>
 <p className="text-[10px] font-semibold text-[var(--muted-foreground)] mt-1">Auto Comments</p>
 </div>
 </div>
 ...
 <h3 className="text-sm font-bold text-[var(--foreground)]">Bot Reply Setup</h3>
 ...
 className="w-full py-3 rounded-xl bg-[var(--muted)] hover:bg-[var(--muted)]/80 text-[var(--foreground)] border border-[var(--border)] font-bold text-[12px] flex items-center justify-center gap-2 transition-all active:scale-95 shadow-sm tracking-wider"
 >
 ...
 <p className="text-[10px] text-[var(--muted-foreground)] font-medium tracking-tight">Sync latest analytics</p>
 </div>
 </button>
 ))}
 </motion.div>
 ...
 <section>
 <h2 className="text-sm sm:text-base lg:text-lg font-bold text-[var(--foreground)] flex items-center gap-2 tracking-tight">
 Latest Interactions
 </h2>
 <p className="text-[10px] font-semibold text-[var(--muted-foreground)] mt-0.5 tracking-wider">Live Activity Feed</p>
 </section>
 ...
 className="px-4 py-2 rounded-xl bg-[var(--primary)] text-[var(--primary-foreground)] font-bold text-[11px] tracking-wide hover:opacity-90 transition-colors shadow-sm whitespace-nowrap"
 >
 ID Lookup
 </button>
 </div>
 ...
 <p className="text-[12px] font-bold text-[var(--muted-foreground)] tracking-widest">No Interaction Active</p>
 </div>
 )}
 ...
 className="flex-1 py-3 sm:py-4 rounded-2xl bg-neutral-50 dark:bg-neutral-800 text-[11px] font-semibold tracking-widest text-neutral-400 hover:text-neutral-600 transition-all active:scale-95"
 >
 No, Cancel
 </button>
 <button
 ...
 className={cn(
 "flex-[2] py-3 sm:py-4 rounded-2xl text-[11px] font-semibold tracking-widest text-white shadow-xl transition-all active:scale-95 disabled:opacity-50",
 ...
 disabled={isDeleting}
 className="flex-[2] py-3 sm:py-4 rounded-2xl text-[11px] font-semibold tracking-widest text-white shadow-xl bg-gradient-to-r from-rose-500 to-pink-600 shadow-rose-500/20 transition-all active:scale-95 disabled:opacity-50"
 >
...
function ReplyCampaignAssignWrapper({ onClose, fetchPosts }: { onClose: () => void; fetchPosts: () => void }) {
 ...
 <span className="text-[11px] font-semibold tracking-widest text-[var(--muted-foreground)] group-hover:text-[var(--foreground)] mr-1">{useSaved ? "YES" : "NO"}</span>
...
export function FullPageCampaignModal({ page, hasCampaign, onClose, onSaved }: { page: any; hasCampaign?: boolean; onClose: () => void; onSaved: () => void }) {
 ...
 <p className="text-[10px] font-bold text-[var(--primary)] leading-none mt-1">Page: {page.page_name}</p>
 </div>
 </div>
 <div className="flex items-center gap-2">
