...
export default function InstagramCommentManagerPage() {
 ...
 <h2 className="text-md font-bold text-[var(--foreground)] dark:text-white tracking-tight">Strategy Lab</h2>

 <div className="relative hidden md:block" ref={templateMenuRef}>
 <button
 ...
 className={cn("group p-3.5 flex items-center justify-between hover:bg-[var(--card)] dark:hover:bg-[var(--muted)] transition-all border-b border-[var(--border)] dark:border-[var(--border)]/50 last:border-0 cursor-pointer", item.hideOnMobile && "hidden md:flex")}
 >
 ...
 <button className="hidden md:flex w-full py-3 rounded-xl bg-[var(--card)] border border-[var(--border)] dark:border-[var(--border)] text-[var(--muted-foreground)] dark:text-[var(--muted-foreground)]/70 font-bold text-[12px] items-center justify-center gap-2 hover:bg-[var(--muted)]/50 transition-all">
 ...
 <span className="text-[9px] font-bold tracking-widest truncate max-w-[100px] sm:max-w-[160px]">ID: {post.id}</span>
 <button
 ...
 <span className="text-[12px] font-bold text-[var(--foreground)] dark:text-[var(--foreground)] tracking-tight">Resume Campaign</span>
 </>
 ) : (
 <>
 <Pause className="w-4 h-4 text-amber-600" />
 <span className="text-[12px] font-bold text-[var(--foreground)] dark:text-[var(--foreground)] tracking-tight">Pause Campaign</span>
 </>
 )}
 </button>
 ...
 <span className="text-[12px] font-bold text-[var(--foreground)] dark:text-[var(--foreground)] tracking-tight">View auto reply report</span>
 </button>
 <button
 onClick={() => {
 ...
 <span className="text-[12px] font-bold text-rose-600 tracking-tight">Delete Auto Reply</span>
 </button>
 </>
 ) : (
 ...
 <Edit3 className="w-4 h-4 text-[var(--primary)] dark:text-[var(--primary)]/80" />
 <span className="text-[12px] font-bold text-[var(--foreground)] dark:text-[var(--foreground)] tracking-tight">Edit auto comment</span>
 </button>
 <button
 onClick={() => {
 setStatusConfirm({
 ...
 <span className="text-[12px] font-bold text-[var(--foreground)] dark:text-[var(--foreground)] tracking-tight">Pause Comment Flow</span>
 </>
 )}
 </button>
 ...
 <BarChart3 className="w-4 h-4 text-emerald-600 dark:text-emerald-400" />
 <span className="text-[12px] font-bold text-[var(--foreground)] dark:text-[var(--foreground)] tracking-tight">View comment report</span>
 </button>
 <button
 onClick={() => {
 ...
 >
 <Trash2 className="w-4 h-4 text-rose-500" />
 <span className="text-[12px] font-bold text-rose-600 tracking-tight">Delete Auto Comment</span>
 </button>
 </>
 ) : (
 <button onClick={() => { setSelectedPostForAuto(post); setShowAutoCommentModal(true); setActiveDropdown(null); }} className="w-full flex items-center gap-3 px-4 py-2.5 hover:bg-[var(--muted)]/50 dark:hover:bg-[var(--muted)] text-left transition-colors">
 <Settings className="w-4 h-4 text-[var(--primary)] dark:text-[var(--primary)]/80" />
 <span className="text-[12px] font-bold text-[var(--foreground)] dark:text-[var(--foreground)] tracking-tight">Auto Comment</span>
 </button>
 )}
 ...
 <span className="text-[10px] font-black text-[var(--muted-foreground)]/70 tracking-widest leading-none">Comments Hub</span>
 </div>
 ...
 <span className="text-[12px] font-bold text-[var(--foreground)] dark:text-[var(--foreground)] tracking-tight">View Comments & Reply</span>
 </button>
 ...
 <span className="text-[12px] font-bold text-[var(--foreground)] dark:text-[var(--foreground)] tracking-tight">Enable Comments</span>
 </>
 ) : (
 <>
 <Pause className="w-4 h-4 text-amber-600" />
 <span className="text-[12px] font-bold text-[var(--foreground)] dark:text-[var(--foreground)] tracking-tight">Disable Comments</span>
 </>
 )}
 </button>

 <button
 onClick={() => { window.open(post.url || `https://instagram.com/p/${post.id}`, "_blank"); setActiveDropdown(null); }}
 className="w-full flex items-center gap-3 px-4 py-2.5 hover:bg-[var(--muted)]/50 dark:hover:bg-[var(--muted)] text-left transition-colors font-bold border-t border-[var(--border)] mt-1"
 >
 <ArrowUpRight className="w-4 h-4 text-pink-600" />
 <span className="text-[12px] font-bold text-[var(--foreground)] dark:text-[var(--foreground)] tracking-tight">View Post on IG</span>
 </button>
 </motion.div>
 )}
 </AnimatePresence>
 ...
 {/* ── Mobile action bar ── */}
 <div className="sm:hidden border-t border-[var(--border)] flex items-stretch">
 <button
 onClick={() => { setSelectedPostForReply(post); setShowPostAutoReplyModal(true); }}
 className="flex-1 py-2.5 flex flex-col items-center justify-center gap-0.5 border-r border-[var(--border)] transition-colors active:bg-[var(--muted)]/40"
 style={{ color: post.status?.reply === "active" ? "var(--primary)" : post.status?.reply === "paused" ? "rgb(217 119 6)" : "var(--muted-foreground)" }}
 >
 {post.status?.reply ? <Edit3 className="w-[15px] h-[15px]" /> : <Megaphone className="w-[15px] h-[15px]" />}
 <span className="text-[9px] font-bold tracking-wide leading-none mt-0.5">
 {post.status?.reply === "active" ? "Reply ✓" : post.status?.reply === "paused" ? "Paused" : "Auto Reply"}
 </span>
 </button>
 <button
 onClick={() => { setSelectedPostForAuto(post); setShowAutoCommentModal(true); }}
 className="flex-1 py-2.5 flex flex-col items-center justify-center gap-0.5 border-r border-[var(--border)] transition-colors active:bg-[var(--muted)]/40"
 style={{ color: post.status?.comment === "active" ? "var(--primary)" : post.status?.comment === "paused" ? "rgb(217 119 6)" : "var(--muted-foreground)" }}
 >
 {post.status?.comment ? <Edit3 className="w-[15px] h-[15px]" /> : <MessageSquare className="w-[15px] h-[15px]" />}
 <span className="text-[9px] font-bold tracking-wide leading-none mt-0.5">
 {post.status?.comment === "active" ? "Comment ✓" : post.status?.comment === "paused" ? "Paused" : "Auto Comment"}
 </span>
 </button>
 <button
 onClick={() => { setSelectedPostForComment(post); setShowCommentNowModal(true); }}
 className="flex-1 py-2.5 flex flex-col items-center justify-center gap-0.5 border-r border-[var(--border)] text-[var(--muted-foreground)] transition-colors active:bg-[var(--muted)]/40"
 >
 <Eye className="w-[15px] h-[15px]" />
 <span className="text-[9px] font-bold tracking-wide leading-none mt-0.5">Comments</span>
 </button>
 <button
 onClick={() => { handleToggleComments(post, !post.is_comment_disabled); }}
 className="flex-1 py-2.5 flex flex-col items-center justify-center gap-0.5 transition-colors active:bg-[var(--muted)]/40"
 style={{ color: post.is_comment_disabled ? "rgb(16 185 129)" : "rgb(245 158 11)" }}
 >
 {post.is_comment_disabled ? <Zap className="w-[15px] h-[15px]" /> : <Pause className="w-[15px] h-[15px]" />}
 <span className="text-[9px] font-bold tracking-wide leading-none mt-0.5">
 {post.is_comment_disabled ? "Enable" : "Disable"}
 </span>
 </button>
 </div>
 </div>
 ...
 <p className="text-[12px] font-bold text-[var(--muted-foreground)]/70 tracking-widest leading-none">No Interaction Active</p>
 ...
 <p className="text-[10px] font-bold text-primary tracking-[0.2em] mt-1 flex items-center gap-2">
 ...
 className="bg-primary text-white px-4 sm:px-6 py-2.5 rounded-xl font-bold text-[12px] tracking-widest shadow-lg shadow-primary/20 active:scale-95 transition-all flex items-center gap-2 whitespace-nowrap flex-shrink-0"
 >
 ...
 <span key={h} className="text-[10px] font-bold text-[var(--muted-foreground)] tracking-widest">{h}</span>
 ))}
 </div>
 ...
 <h3 className="text-base font-bold text-[var(--muted-foreground)] tracking-tight">Inventory Empty</h3>
 ...
 <div className="w-7 h-7 rounded-lg shrink-0 flex items-center justify-center bg-gradient-to-tr from-yellow-400 via-pink-500 to-purple-500">
 <Instagram className="w-4 h-4 text-white" />
 </div>
 <div className="flex flex-col min-w-0">
 <span className="text-[9px] font-medium tracking-widest leading-none text-pink-500">Instagram</span>
 ...
 <span className="text-[10px] font-bold text-[var(--muted-foreground)] tracking-wider">Live Sync</span>
 </div>
 </div>
 </div>
 </div>
 ...
 ? "bg-gradient-to-r from-pink-500 to-purple-600 border-pink-500 text-white shadow-sm"
 : "border-[var(--border)] text-[var(--muted-foreground)] hover:text-[var(--foreground)] bg-[var(--card)]"
 )}
 >
 <div className={cn("w-4 h-4 rounded-[4px] overflow-hidden border border-white/20", selectedAccount?.id === acc.id ? "opacity-100" : "opacity-60")}>
 ...
 className="flex-1 py-4 rounded-2xl bg-neutral-50 dark:bg-neutral-800 text-[11px] font-semibold tracking-widest text-neutral-400 hover:text-neutral-600 transition-all active:scale-95"
 >
 No, Cancel
 </button>
 <button
 ...
 className={cn(
 "flex-[2] py-4 rounded-2xl text-[11px] font-semibold tracking-widest text-white shadow-xl transition-all active:scale-95 disabled:opacity-50",
 ...
 disabled={isDeleting}
 className="flex-[2] py-4 rounded-2xl bg-gradient-to-r from-rose-500 to-pink-600 text-white font-semibold text-[11px] tracking-widest shadow-xl shadow-rose-500/20 active:scale-95 transition-all disabled:opacity-50"
 >
 ...
 <div className="space-y-2">
 <h3 className="text-xl font-bold text-neutral-900 dark:text-white tracking-tight">Campaign is Live!</h3>
 ...
 className="w-full py-4 rounded-2xl bg-neutral-900 dark:bg-[var(--card)] text-white dark:text-[var(--foreground)] text-[11px] font-black tracking-widest shadow-xl transition-all active:scale-95 disabled:opacity-50"
 >
 {isPausingAllOthers ? "Processing..." : "Yes, Pause all Others"}
 </button>
 <button
 onClick={() => setShowPauseAllOthersModal(false)}
 className="w-full py-4 rounded-2xl bg-neutral-50 dark:bg-neutral-800 text-[11px] font-bold tracking-widest text-neutral-400 hover:text-neutral-600 transition-all active:scale-95"
 >
 No, Keep them active
 </button>
 </div>
 ...
 {/* ── MOBILE BOTTOM NAV (Instagram Manager) ── */}
 ...
 <div className="w-9 h-8 rounded-xl flex items-center justify-center transition-all duration-200"
 style={activeView === "comment-templates" ? { background: "var(--nav-active-bg)" } : { background: "transparent" }}
 >
 ...
 <div className="w-9 h-8 rounded-xl flex items-center justify-center transition-all duration-200"
 style={activeView === "reply-templates" ? { background: "var(--nav-active-bg)" } : { background: "transparent" }}
 >
