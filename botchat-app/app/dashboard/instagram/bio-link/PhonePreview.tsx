...
export const PhonePreview = ({ profile, tabs, selectedTabId, setSelectedTabId, viewportOffset = 280, previewWidth = 300, uiTypeOverrides = {} }: any) => {
    ...
    const topAvatar = allBlocks.find(b => getUiTypeFromBlock(b, uiTypeOverrides) === "avatar");
