   ...
   return (
      <div className="fixed inset-0 z-[1000] flex items-center justify-center p-0 sm:p-4">
         ...
         <motion.div
            ...
            className="relative z-10 w-full max-w-none sm:max-w-[650px] min-h-screen sm:min-h-0 bg-white dark:bg-slate-900 rounded-none sm:rounded-[32px] shadow-2xl overflow-hidden flex flex-col border border-white dark:border-slate-800 max-h-[90vh] my-8"
         >
            {/* Header */}
            <div className="px-10 py-8 border-b border-slate-50 dark:border-slate-800/50 flex items-center justify-between bg-white dark:bg-slate-950/20 backdrop-blur-md sticky top-0 z-10">
               <div>
                  ...
                  <p className="text-[10px] font-bold text-pink-500 uppercase tracking-widest mt-1">Instagram Core Mapping</p>
               </div>
            ...
            <div className="p-10 space-y-10 overflow-y-auto max-h-[70vh] no-scrollbar">
               ...
               <div className="space-y-4">
                  <div className="flex items-center gap-2 mb-1">
                     ...
                     <label className="text-[12px] font-bold text-slate-500 uppercase tracking-wider">Attribute Display Name</label>
                  </div>
               ...
               <div className="space-y-4">
                  <div className="flex items-center gap-2 mb-1">
                     ...
                     <label className="text-[12px] font-bold text-slate-500 uppercase tracking-wider">Validation Protocol</label>
                  </div>
                  <div className="relative group">
                     <select
                        value={form.type}
                     ...
                     >
                        {VALIDATION_TYPES.map(t => (
                           <option key={t.value} value={t.value} className="bg-white dark:bg-slate-900">{t.label} Capture</option>
                        ))}
                     </select>
                  ...
                  <div className="flex items-center gap-2 p-4 bg-pink-50/50 dark:bg-pink-900/10 rounded-2xl border border-pink-100/50 dark:border-pink-900/20">
                     ...
                     <p className="text-[11px] font-bold text-pink-600/70 dark:text-pink-500/70 uppercase tracking-wide">
                        Logic: Filter for <span className="text-pink-600 dark:text-pink-400 font-black">{form.type}</span> compliance.
                     </p>
                  </div>
               </div>
               ...
               <div className="flex items-center justify-between py-6 px-8 rounded-[24px] bg-slate-50/30 dark:bg-slate-950/30 border-2 border-slate-50 dark:border-slate-800/50 group transition-all hover:bg-white dark:hover:bg-slate-900 hover:border-pink-100 dark:hover:border-pink-900/20">
                  <div className="flex items-center gap-4">
                     ...
                     <span className="text-[13px] font-black text-slate-800 dark:text-white uppercase tracking-tight">Live Sync Status</span>
                  </div>
         ...
         <div className="bg-white dark:bg-slate-900 border-b border-slate-50 dark:border-slate-800 sticky top-0 z-40">
            <div className="max-w-[1400px] mx-auto px-8 py-6 flex items-center justify-between">
               ...
               <button
                  ...
                  className="px-10 py-4 bg-[var(--primary)] text-[var(--primary-foreground)] font-black text-[12px] rounded-[22px] shadow-2xl shadow-[var(--primary)]/15 active:scale-95 transition-all flex items-center gap-3 uppercase tracking-widest"
               >
