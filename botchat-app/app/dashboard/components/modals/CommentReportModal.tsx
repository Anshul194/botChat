    ...
    return (
        <div className="fixed inset-0 z-[1000] flex items-center justify-center p-0 sm:p-4">
            ...
            <motion.div
                ...
                className="bg-[var(--card)] dark:bg-neutral-900 border border-neutral-200 dark:border-neutral-800 rounded-none sm:rounded-2xl w-full max-w-3xl shadow-2xl relative z-10 overflow-hidden flex flex-col h-[100dvh] sm:h-auto sm:max-h-[85vh]"
            >
                {/* Header */}
                <div className="p-4 sm:p-8 border-b border-neutral-100 dark:border-neutral-800 flex items-center justify-between bg-neutral-50/50 dark:bg-neutral-950/20">
                    <div className="flex items-center gap-3 sm:gap-5 min-w-0">
                        <div className="w-10 h-10 sm:w-12 sm:h-12 rounded-xl sm:rounded-2xl bg-emerald-500/10 text-emerald-600 flex items-center justify-center shadow-inner shrink-0">
                            <BarChart3 className="w-5 h-5 sm:w-6 sm:h-6" />
                        </div>
                        <div className="min-w-0">
                            <h2 className="text-base sm:text-lg font-black text-neutral-900 dark:text-white uppercase tracking-tight leading-none truncate">Campaign Execution Report</h2>
                            <p className="text-[10px] text-neutral-400 font-bold uppercase tracking-widest mt-1 sm:mt-2 border-l-2 border-emerald-500 pl-3 ml-0.5 truncate">Automated Lifecycle Analytics</p>
                        </div>
                    </div>
                    <div className="flex items-center gap-2 sm:gap-3 shrink-0">
                        <button onClick={() => fetchReport()} className="p-2 sm:p-3 rounded-xl sm:rounded-2xl hover:bg-neutral-100 dark:hover:bg-neutral-800 transition-all text-neutral-400">
                            <RefreshCw className={cn("w-4 h-4 sm:w-5 sm:h-5", isLoading && "animate-spin")} />
                        </button>
                        <button onClick={onClose} className="p-2 sm:p-3 rounded-xl sm:rounded-2xl hover:bg-rose-50 dark:hover:bg-rose-900/20 transition-all text-neutral-400 hover:text-rose-500">
                ...
                {/* Content */}
                <div className="flex-1 overflow-y-auto p-4 sm:p-8 space-y-6 sm:space-y-8 custom-scrollbar bg-[var(--card)] dark:bg-neutral-900">
                ...
                {/* Footer */}
                <div className="p-4 sm:p-8 border-t border-neutral-100 dark:border-neutral-800 bg-neutral-50/50 dark:bg-neutral-950/20 flex flex-col sm:flex-row items-stretch sm:items-center justify-between gap-3">
                    <div className="flex items-center gap-3">
                        {meta && meta.last_page > 1 && (
                            <div className="flex items-center gap-2">
                                <button 
                                    ...
                                    className="px-3 sm:px-4 py-2 rounded-xl bg-[var(--card)] dark:bg-neutral-800 border border-neutral-200 dark:border-neutral-700 text-[10px] font-black uppercase tracking-widest text-neutral-400 hover:text-primary transition-all disabled:opacity-30"
                                >
                                    Back
                                </button>
                                <span className="text-[10px] font-black text-neutral-400 uppercase tracking-[0.2em] px-2 sm:px-3">
                    ...
                    <button 
                        onClick={onClose}
                        className="px-6 sm:px-8 py-3 sm:py-4 rounded-xl sm:rounded-2xl bg-[var(--card)] dark:bg-neutral-800 border border-neutral-200 dark:border-neutral-700 text-[11px] font-black uppercase tracking-widest text-neutral-500 hover:bg-neutral-50 transition-all active:scale-95 shadow-sm"
                    >
                        Close Analytics
                    </button>
                </div>
