                    ...
                    <div className="flex-1 overflow-y-auto p-8 space-y-8 bg-[var(--card)] custom-scrollbar">
                        ...
                        {isLoading ? (
                            <div className="h-[400px] flex flex-col items-center justify-center space-y-4">
                                ...
                                <p className="text-sm font-medium text-[var(--muted-foreground)]/70">Loading configuration...</p>
                            </div>
                        ) : (
                            <motion.div initial={{ opacity: 0 }} animate={{ opacity: 1 }} className="space-y-8">
                                ...
                                <div className="bg-[var(--card)] border border-[var(--border)] rounded-xl p-6 shadow-xs space-y-5">
                                    <div className="flex items-center gap-4 cursor-pointer group" onClick={() => setReplyType("generic")}>
                                        ...
                                        <span className={cn("text-sm font-medium", replyType === "generic" ? "text-[var(--primary)]" : "text-[var(--muted-foreground)]/70")}>Generic message for all comments</span>
                                    </div>
                                    <div className="flex items-center gap-4 cursor-pointer group" onClick={() => setReplyType("filter")}>
                                        ...
                                        <span className={cn("text-sm font-medium", replyType === "filter" ? "text-[var(--primary)]" : "text-[var(--muted-foreground)]/70")}>Send different messages by keyword filter</span>
                                    </div>
                                </div>
