...
import {
    Mail, Lock, Eye, EyeOff, MessageSquare, Zap, Check, AlertCircle, Loader2,
} from "lucide-react";
...
function ResetPasswordForm() {
    ...
    const handleSubmit = async (e: React.FormEvent) => {
        ...
        try {
            ...
            setMessage(typeof err === "string" ? err : err?.message || "Password reset failed. Please try again.");
            setStatus("error");
        }
    };
                ...
                <div className="flex-1 flex items-center justify-center px-6 py-8">
                    ...
                    >
                        <div className="mb-8">
                            ...
                            <p className="text-sm flex items-center gap-1.5" style={{ color: isLight ? "#64748b" : "#94a3b8" }}>
                                <Mail className="w-3.5 h-3.5" /> {email || "Resetting password"}
                            </p>
                        </div>
                        ...
                        {missingParams ? (
                            ...
                            >
                                ...
                                <div>
                                    ...
                                    <div className="relative">
                                        <Lock className="absolute left-3.5 top-1/2 -translate-y-1/2 w-4 h-4 pointer-events-none"
                                            style={{ color: errors.confirm ? "#ef4444" : isLight ? "#94a3b8" : "#64748b" }} />
                                        <input
                                            ...
                                            style={{
                                                ...
                                                boxShadow: errors.confirm ? "0 0 0 3px rgba(239,68,68,0.1)" : "none",
                                            }}
                                        />
                                ...
                                >
                                    {status === "loading" ? (
                                        ...
                                        <><Check className="w-5 h-5" strokeWidth={3} /> Password updated!</>
                                    ) : (
                                        "Reset Password"
                                    )}
                                </motion.button>
