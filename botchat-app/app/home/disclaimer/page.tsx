  ...
  return (
    <article className="prose prose-pink prose-invert max-w-none">
      <div className="mb-12">
        ...
        <p className="text-slate-400 font-medium">Last Updated: July 29, 2026</p>
      </div>

      <div className="space-y-12 text-slate-300 leading-relaxed">
        <section>
          <h2 className="text-2xl font-bold text-white mb-4">1. Information Accuracy</h2>
          <p>
        ...
        <section>
          <h2 className="text-2xl font-bold text-white mb-4">2. Cache Behavior & Data Freshness</h2>
          <p>
          ...
          <div className="bg-yellow-500/10 border-l-4 border-yellow-500 p-4 mt-6 rounded-r-xl">
            <p className="font-semibold text-yellow-300"> ⚠ Important Note on Cache</p>
        ...
        <section>
          <h2 className="text-2xl font-bold text-white mb-4">3. Third-Party Platform Dependence</h2>
          <p>
        ...
        <section>
          <h2 className="text-2xl font-bold text-white mb-4">6. Changes to This Disclaimer</h2>
          <p>
